...
ap.add_argument("-v", "--video", default='video/video.640.480.avi', help="path to the video file")
    ...
    if framecounter > 1:
        ...
        for c in cnts:
           ...
           # if the contour is too small, ignore it
            ...
            prott1 = r'mobilenet\MobileNetSSD_deploy.prototxt.txt'
            prott2 = r'mobilenet\MobileNetSSD_deploy.caffemodel'
